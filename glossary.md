...
- **dpi (dots per inch)** — pixel *size* flipped into pixel *density*: if a pixel is p inches wide, dpi = 1/p. Historically a printing term (ppi is the more precise word for screens), but used interchangeably with pixel density here (§9).
